 ...
 */
$omegaRoot = DRUPAL_ROOT . '/' . \Drupal::service('extension.list.theme')->getPath('omega');
 ...
 * @return string
 */
function _omega_compile_layout_sass($options, $layout, $layoutName, $theme = 'omega') {
 ...
 */
function _omega_layout_generation_adjust($cols,$main, $empty_regions = array()) {
