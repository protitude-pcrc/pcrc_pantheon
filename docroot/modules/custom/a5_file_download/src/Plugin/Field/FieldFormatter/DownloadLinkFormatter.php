...
namespace Drupal\a5_file_download\Plugin\Field\FieldFormatter;
 ...
 * )
 */
class DownloadLinkFormatter extends FileFormatterBase implements ContainerFactoryPluginInterface {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($this->getEntitiesToView($items, $langcode) as $delta => $file) {
      ...
      $elements[$delta] = [
        '#type' => 'link',
        '#url' => Url::fromRoute('a5_file_download.file_download', ['fid' => $file->id()]),
        '#title' => $link_text,
